        ...
        <div className="flex items-center bg-slate-900 p-1.5 rounded-xl border border-slate-800 text-xs font-semibold">
          <button
            ...
            className={`px-3.5 py-1.5 rounded-lg transition ${
              activeTab === 'centrality' ? 'bg-cyan-600 text-black font-bold' : 'text-slate-400 hover:text-slate-200'
            }`}
          >
            Centrality Rankings
          </button>
          <button
            ...
            className={`px-3.5 py-1.5 rounded-lg transition ${
              activeTab === 'communities' ? 'bg-cyan-600 text-black font-bold' : 'text-slate-400 hover:text-slate-200'
            }`}
          >
            Community Clusters
          </button>
