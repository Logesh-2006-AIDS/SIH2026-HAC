...
from app.api.v1.endpoints import health, auth, ingest, graph, cases, leads, audit, nlp, copilot, map, analyst, admin, search
...
api_router.include_router(search.router, prefix="/search", tags=["Global Entity Search"])
...
api_router.include_router(analyst.router, prefix="/analyst", tags=["Analyst Intelligence"])
